...
test('logged-in mock replay: popup shows recent chats', recentStreamsPopupScenario);
...
test('logged-in mock replay: replaced translations toggle across chat surfaces', replacedTranslationToggleSurfacesScenario);

---
title: "Video + Chat PiP ist jetzt in Version 1.1.0 verfügbar"
date: 2026-09-11
description: "Behalte einen YouTube-Stream und seinen Livechat in einem schwebenden Fenster im Blick, während du andere Tabs und Apps nutzt."
...
![Das Untermenü von Chat Enhancer mit der Option Video + Chat PiP. Alle Chatnamen, Avatare und Nachrichten sind erfunden.](./menu.png) {shadow=smooth}

Auf einer YouTube-Videoseite mit geöffnetem Livechat:

1. Klicke oben im Chat auf die drei Punkte für **Weitere Optionen**.
2. Öffne **Chat Enhancer**.
3. Wähle **Video + Chat PiP**.
...
![Ein breites Bild-im-Bild-Fenster mit Video und einem erfundenen Livechat nebeneinander.](./pip-wide.png) {shadow=smooth}

:::media-right

![Ein kompaktes Bild-im-Bild-Fenster mit den YouTube-Player-Steuerelementen über einer erfundenen Chatunterhaltung.](./pip-stacked.png)

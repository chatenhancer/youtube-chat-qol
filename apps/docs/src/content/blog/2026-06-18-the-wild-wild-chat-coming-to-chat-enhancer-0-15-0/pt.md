...
date: 2026-06-18
description: "The Wild Wild Chat transforma o chat ao vivo em uma caça rápida por recompensas, em que jogadores disputam mensagens correspondentes."
locale: "pt"
...
![Quadro de procurados de Bounty Hunting](./64a11deb8049b2c9-pt.webp){shadow=smooth;rotate=-6deg}

### Como funciona

Comece uma partida do Playground no chat ao vivo, convide outro jogador e espere um momento enquanto a rodada é preparada.

Cada rodada traz seis recompensas baseadas em coisas que acontecem naturalmente no chat. Talvez você precise encontrar uma mensagem com 3+ emojis, uma mensagem em maiúsculas, uma pergunta, uma menção a usuário, alguém verificado no chat, um link, um número, uma frase repetida ou uma das pessoas mais ativas no chat.

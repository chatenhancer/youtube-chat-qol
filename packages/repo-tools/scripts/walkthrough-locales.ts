...
const docsLocalesDir = path.join(repoRoot, 'apps', 'docs', 'src', 'i18n');
const extensionLocalesDir = path.join(repoRoot, 'apps', 'extension', 'src', 'shared', 'locales');
const walkthroughDemoCopyPath = path.join(scriptsDir, 'walkthrough-demo-copy.json');

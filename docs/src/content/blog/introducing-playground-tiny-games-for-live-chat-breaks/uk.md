...
Стример відійшов на хвилину? Відкрийте Playground, зіграйте швидку партію й не випускайте чат з поля зору.
...
Гра «Шахи» була першою в Playground і досі найкраще пояснює ідею: коротка активність поруч із чатом, яка не захоплює всю сторінку.
...
Playground — це не повноцінна ігрова кімната, прикручена до YouTube. Він створений для спокійних моментів стриму, коли чат відкритий, але майже нічого не відбувається.

Тому «Шахи» навмисно компактні:

- Вона запускається з панелі «Ігри» усередині розширення.
...
Сценарій лишається тим самим: відкрийте панель «Ігри», запросіть глядача або суперника Computer, якщо це підтримується, зіграйте компактний матч і тримайте стрим поруч.

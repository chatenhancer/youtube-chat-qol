...
date: 2026-06-10
description: "Playground は、配信が少し落ち着いた時間に楽しめるコンパクトなゲームを YouTube ライブチャットに追加します。"
locale: "ja"
...
配信者が少し席を外したら？Playground を開いて、短い対戦をしながら、チャットもすぐそばに置いておけます。
...
チェスは最初の Playground ゲームで、今でもこの考え方を一番よく表しています。ページを占領するのではなく、チャットの近くに置いておける短いサイドアクティビティです。
...
Playground は、YouTube に無理やり追加した本格ゲームルームではありません。チャットは開いているけれど動きが少ない、そんな配信中のゆるい時間のためのものです。

だからチェスは、あえて小さく作っています。

- 拡張機能内のゲームパネルから始められます。
- コンパクトで移動できる盤面を使います。
- 現在の配信で Chat Enhancer を使っている、参加可能なプレイヤーだけを表示します。
- YouTube のほかの部分を表示したままにするので、すぐチャットに戻れます。

Playground の設定は拡張機能のポップアップにあります。
...
流れは同じです。ゲームパネルを開き、対応している場合は視聴者または Computer の相手を招待し、コンパクトな対戦をしながら、配信をすぐ近くに置いておけます。

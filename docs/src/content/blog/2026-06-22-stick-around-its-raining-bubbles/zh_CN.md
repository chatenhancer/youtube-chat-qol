...
date: 2026-06-22
description: "Stick Around! 会把直播聊天流变成一个小小的格斗场，聊天泡泡从上方落下，最后站着的火柴人获胜。"
...
在 Stick Around! 里，聊天不是命令系统。观众不会输入特殊关键词，评论也不会触发隐藏攻击。
...
更深或更浅的覆盖层会让游戏保持清晰，同时底下的聊天仍然可见，所以它仍然感觉和直播连在一起，而不是变成单独的屏幕。
...
所以落下的泡泡来自聊天量。慢速直播会变成轻松对局。快速直播会变成风暴。评论仍然是评论，但对话越热闹，房间就越危险。

...
现在更容易直接进入 Playground 了：你可以和 **Computer** 对战。

有时候聊天室很安静。有时候你的朋友正在看别的直播。有时候你只是想快速玩一局，不想等别人接受邀请。Computer 给了你另一个选择。
...
在 *HELP-A-FRIEND! Trivia* 中，Computer 会在答题回合像其他玩家一样作答。它并不完美，所以你仍然有真正赢下来的机会。

## 为什么添加它？

当有人可以一起玩时，Playground 最有趣，但直播聊天并不总是可预测。Computer 可以让游戏在更安静的时刻、深夜直播、回放，或小型社区中依然可用，因为这些时候未必总有另一个 Chat Enhancer 用户在线。

...
이제 Playground에 더 쉽게 들어갈 수 있습니다. **Computer**와 플레이할 수 있습니다.

때로는 채팅이 조용합니다. 때로는 친구들이 다른 스트림을 보고 있습니다. 때로는 다른 사람이 수락하기를 기다리지 않고 빠르게 한 판 하고 싶을 때도 있습니다. Computer는 그런 순간을 위한 또 하나의 선택지입니다.
...
*HELP-A-FRIEND! Trivia*에서는 Computer가 질문 라운드 중 다른 플레이어처럼 답합니다. 완벽하지는 않기 때문에 여전히 이길 실제 기회가 있습니다.

## 왜 추가했나요?

Playground는 함께 플레이할 사람이 있을 때 가장 재미있지만, live chat은 예측하기 어렵습니다. Computer는 조용한 순간, 늦은 밤 스트림, 리플레이, 또는 다른 Chat Enhancer 사용자가 항상 있지는 않은 작은 커뮤니티에서도 게임을 계속 사용할 수 있게 해 줍니다.

...
Le prochain jeu Playground arrive au galop dans le chat en direct : **The Wild Wild Chat**.

Il commence avec **Bounty Hunting**, une chasse rapide où deux joueurs regardent le même chat de stream et font la course pour trouver les bons messages avant la fin du temps imparti.

:::media-right

![Tableau des avis de recherche Bounty Hunting](./64a11deb8049b2c9.png){shadow=smooth;rotate=-6deg}

### Comment ça marche

Lancez une partie Playground depuis le chat en direct, invitez un autre joueur et attendez un instant pendant que le jeu prépare la manche.

Chaque manche reçoit six primes basées sur ce qui arrive naturellement dans le chat. Vous devrez peut-être trouver un message avec 3+ émojis, un message en majuscules, une question, une mention d’utilisateur, un participant vérifié, un lien, un nombre, une phrase répétée ou l’un des participants les plus actifs.

Les deux joueurs appuient sur **Prêt**, puis un court compte à rebours 3, 2, 1 lance la vraie chasse. Ensuite, vous avez 60 secondes.
...
Le tableau des avis de recherche affiche **Eux contre vous**, le chrono en direct et les six primes ouvertes. Chaque prime a une valeur en argent, une description et un tampon **Ouverte** ou **Réclamée**.
...
Après un court écran de fin de manche, **The Ledger** affiche le résultat final. Le gagnant apparaît en premier, suivi de l’autre joueur, avec l’avatar, le rang, les primes réclamées et l’argent gagné de chacun. Le joueur qui a le plus d’argent gagne.
...
Il existe aussi un mode compact pour ce jeu. Si l’affiche complète prend trop de place dans le chat, réduisez le panneau en une petite ligne qui garde le chrono et le score visibles tout en rendant le chat plus facile à lire.
...
Playground reste optionnel. Activez **Join Playground** dans les paramètres de l’extension, ouvrez un direct avec chat et cherchez le bouton Jeux quand la mise à jour arrivera.

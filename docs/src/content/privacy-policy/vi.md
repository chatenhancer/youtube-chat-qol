...
Cập nhật lần cuối: ngày 17 tháng 6 năm 2026
...
- **Trạng thái tab live chat được lưu bằng `chrome.storage.local`:** dữ liệu này chỉ gồm ID tab trình duyệt và dấu thời gian nhìn thấy gần nhất của các tab live chat YouTube hoạt động gần đây, và được dùng để cho biết tiện ích hiện đang kết nối hay đã ngắt kết nối. Các bản ghi này hết hạn sau 12 giờ.

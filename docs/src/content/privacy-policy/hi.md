...
- **Bookmarked user डेटा:** local extension storage (`chrome.storage.local`) में saved होता है। इसमें bookmarked user का handle, उपलब्ध होने पर channel ID, और bookmark बनाए जाने का समय शामिल है। Bookmarked users मौजूदा browser profile में streams के बीच global होते हैं और colored avatar rings दिखाने के लिए उपयोग होते हैं।

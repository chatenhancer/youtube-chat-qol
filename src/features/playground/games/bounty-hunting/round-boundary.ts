...
const BOUNTY_HUNTING_START_DIVIDER_HOST_BEFORE_CLASS = 'ytcq-bounty-hunting-start-divider-host-before';
const BOUNTY_HUNTING_START_DIVIDER_HOST_AFTER_CLASS = 'ytcq-bounty-hunting-start-divider-host-after';
...
function findBountyHuntingRoundStartPlacement(
  runtime: BountyHuntingPanelRuntime
): { anchor: HTMLElement | null; firstAfter: HTMLElement | null } {
...
function getBountyHuntingRoundStartDivider(runtime: BountyHuntingPanelRuntime): HTMLElement {
  ...
  divider.textContent = t('gamesBountyHuntingStartsHere');
...
function getBountyHuntingRoundStartDividerHost(
  placement: { anchor: HTMLElement | null; firstAfter: HTMLElement | null }
